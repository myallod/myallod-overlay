...
src_install() {
	...
	keepdir /etc/filebeat

	dodir /var/lib/filebeat/module || die
	insinto /var/lib/filebeat/
	doins -r filebeat/module || die

	dodir /etc/filebeat/modules.d || die
	insinto /etc/filebeat/
	doins -r filebeat/modules.d || die
