...
ruby_add_rdepend "
	>=dev-ruby/msgpack-0.7.0 <dev-ruby/msgpack-2.0.0
	=dev-ruby/yajl-ruby-1*
	>=dev-ruby/coolio-1.4.5 <dev-ruby/coolio-2.0.0
	>=dev-ruby/serverengine-1.4.5 <dev-ruby/serverengine-2.0.0
	>=dev-ruby/http_parser_rb-0.5.1 <dev-ruby/http_parser_rb-0.7.0
	=dev-ruby/sigdump-0.2*
	=dev-ruby/tzinfo-1*
	=dev-ruby/tzinfo-data-1*
	=dev-ruby/strptime-0.1*
	=dev-ruby/ruby_dig-0.0*"
